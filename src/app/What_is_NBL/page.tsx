    ...
    <main className=" ">
      <div className="relative h-[70vh] flex items-center justify-center bg-blue-950 text-white ">
        ...
        >
          <h1 className="text-5xl font-bold mb-4">
            NASA Neutral Buoyancy Laboratory (NBL)
          </h1>
          <p className="!text-lg">
            The world’s largest indoor pool for astronaut training — simulating
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
        <motion.div {...FadeRight} {...ViewPort} {...transition}>
          ...
          <p className="!text-lg leading-relaxed">
            ...
            training facility located at the Sonny Carter Training Facility near
            Johnson Space Center in Houston, Texas. The NBL houses a massive
            indoor pool containing 6.2 million gallons of fresh water. By using
            neutral buoyancy underwater, astronauts simulate the microgravity
            environment of space, practicing extravehicular activities (EVAs)
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
          ...
          <motion.div {...FadeRight} {...ViewPort} {...transition}>
            ...
            <p className="!text-lg leading-relaxed">
              ...
              deep — large enough to hold full-size mockups of the International
              Space Station (ISS) modules. The facility integrates control
              rooms, video and audio systems, engineering labs, and professional
              dive teams to create a controlled, realistic training environment.
            </p>
            <p className="!text-lg leading-relaxed mt-3">
              Every year, hundreds of hours of EVA training and hardware testing
              are conducted, ensuring astronauts are fully prepared for space
              operations.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
          <motion.div {...FadeRight} {...ViewPort} {...transition}>
            ...
            <p className="!text-lg leading-relaxed mt-3">
              ...
              hours underwater for every hour of real EVA — building confidence,
      ...
      <div className="text-center py-16">
        ...
        >
          ...
          <p className="!text-lg leading-relaxed">
            The Neutral Buoyancy Laboratory remains one of NASA’s most valuable
            assets for astronaut training. Its underwater environment provides
            the closest possible experience to working in space, allowing
            astronauts to perfect the art of spacewalking — ensuring mission
