...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  const [textLines, setTextLines] = useState<string[]>([t("Menu"), t("Close")]);
  ...
  const animateText = useCallback((opening: boolean) => {
    ...
    const currentLabel = opening ? t("Menu") : t("Close");
    const targetLabel = opening ? t("Close") : t("Menu");
    const cycles = 3;

    const seq: string[] = [currentLabel];
    let last = currentLabel;
    for (let i = 0; i < cycles; i++) {
      last = last === t("Menu") ? t("Close") : t("Menu");
      seq.push(last);
    }
    ...
    <div className="sm-scope w-full h-full">
      ...
      >
        ...
        >
          ...
          >
            <img
              ...
              alt="Logo"
              className="  block h-10 w-auto object-contain rounded-2xl"
              draggable={false}
              width={110}
              height={24}
            />
        ...
        <aside
          ...
          }  top-0 h-screen w-full lg:w-fit fixed  bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px]`}
