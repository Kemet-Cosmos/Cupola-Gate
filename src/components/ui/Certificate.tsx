...
export default function CertificatePDf({ certificate }: CertificateProps) {
  ...
  return (
    <div className="flex flex-col items-center">
      <div
        ref={certificateRef}
        className={`relative w-full max-w-7xl mx-auto rounded-4xl mt-5 py-32 p-10 flex flex-col justify-center items-center gap-5 text-center overflow-hidden ${
        ...
        {certificate.title === "modern" ? (
          <>
            ...
            <div className="max-w-3xl text-center">
              <p>
                for successfully completing all exploration stages of CupolaGate
              </p>
              <p>
                Your curiosity, effort, and persistence have brought you to the
                edge of discovery, Keep reaching for the stars!
              </p>
            </div>
          </>
        ) : (
          <>
            ...
            <h1 className="text-[#ffda6a] mb-5 z-10">{certificate.fullName}</h1>
